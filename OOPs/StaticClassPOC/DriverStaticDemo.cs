    ...
    public class DriverStaticDemo
    {
        public static void Main(String[] args)
        {
            ...
            */
            ...
            StaticDemo.area(2); // We have two method with same name area but with different no of paramater called overloading , Now which method will be called here ? It will decide by compire with comparing with differences between these method w.r.t
